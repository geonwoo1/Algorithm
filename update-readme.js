        ...
        if (fs.statSync(folderPath).isDirectory()) {
            ...
            problemFiles.forEach(file => {
                ...
                if (folder.includes('0')) {
                    ...
                    problemsByLevel['LEVEL 0'].push(`- [${problemName}](프로그래머스/${folder}/${file})`);
                } else if (folder.includes('1')) {
                    difficultyCount['LEVEL 1']++;
                    problemsByLevel['LEVEL 1'].push(`- [${problemName}](프로그래머스/${folder}/${file})`);
...
#### LEVEL 0 문제:
${problemsByLevel['LEVEL 0'].join('\n')}

#### LEVEL 1 문제:
${problemsByLevel['LEVEL 1'].join('\n')}

#### LEVEL 2 문제:
${problemsByLevel['LEVEL 2'].join('\n')}

#### LEVEL 3 문제:
${problemsByLevel['LEVEL 3'].join('\n')}

#### LEVEL 4 문제:
${problemsByLevel['LEVEL 4'].join('\n')}
---
